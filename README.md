...
## Demo video
[Demo video](https://drive.google.com/file/d/1WA992A8Im8qQ3rMWJrj7uSpAo1o2S_rh/view?usp=sharing)
...
* project_file.py has several arguments
  ...
  * -fd               : (required) Specify the path of Face Detection model's name as shown below for specific precision "FP32-INT1"
  ...
  ```
  * -fld               : (required) Specify the path of Facial landmarks Detection model's name as shown below for specific precision "FP16"
  ```
  -fld "C:\Program Files (x86)\IntelSWTools\openvino_2020.1.033\deployment_tools\open_model_zoo\tools\downloader\intel\landmarks-regression-retail-0009\FP16\landmarks-regression-retail-0009"
  ```
